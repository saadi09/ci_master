            ...
            <div style="left: 50%; transform: translateX(-50%);" class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <strong><span class="icon icon-plus-circle"></span> EDIT BRAND</strong>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="title" placeholder="Title" value="<?= $brand_detail['title'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="alt" placeholder="ALT Name" value="<?= $brand_detail['alt'] ?>">
                                    </div>
                                </div>
                            </div>
