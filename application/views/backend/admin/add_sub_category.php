                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal" style="margin-top: 30px" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="category" class="col-sm-3 control-label" style="width: 20%;" for="form-control-17">Category</label>
                                <div class="col-sm-9">
                                    <select id="demo-select2-1" class="form-control" name="category">
                            ...
                            <div class="form-group">
                                <label for="brand" class="col-sm-3 control-label" style="width: 20%;" for="form-control-17">Brand</label>
                                <div class="col-sm-9">
                                    <select id="dropdown" class="form-control" name="brand">
                                        <option value="0">SELECT BRAND</option>
                                        <?php
                                        if (count($brand) > 0) {
                                            for ($i = 0; $i < count($brand); $i++) {
                                                ?>
                                                <option value="<?php echo $brand[$i]['id'] ?>"><?php echo $brand[$i]['title'] ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
