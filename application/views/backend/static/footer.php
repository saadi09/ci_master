<div class="layout-footer">
    ...
    <script src="<?= base_url() ?>assets/<?php echo $theme?>/js/vendor.min.js"></script>
    <script src="<?= base_url() ?>assets/<?php echo $theme?>/js/elephant.min.js"></script>
    <script src="<?= base_url() ?>assets/<?php echo $theme?>/js/application.min.js"></script>
    <script src="<?= base_url()?>assets/<?php echo $theme?>/js/demo.min.js"></script>
    <script>
