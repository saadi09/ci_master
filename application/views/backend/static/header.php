                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown hidden-xs ">
                        <button class="navbar-account-btn" data-toggle="dropdown" aria-haspopup="true">
                            ...
                            <img class="rounded" width="36" height="36" src="<?php echo base_url()?>assets/<?= $theme ?>/img/0180441436.jpg" >
                        ...
                        <div class="dropdown-menu dropdown-menu-right animated fadeInDown">
                            ...
                            <div class="col-md-12">
                                ...
                                <img class="rounded"  src="<?php echo base_url()?>assets/<?= $theme ?>/img/0180441436.jpg" width="120px" height="90px" >
                            ...
                            <div class="col-md-6 margin">
                                <span><a href="<?= base_url().'Admin/change_password'?>"><span class="icon icon-cog"></span>  Settings</a></span>
